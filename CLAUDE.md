...
npm test                 # Run Jest tests (jsdom, 207 test files)
...
```bash
npm test                    # Run all 207 unit test files (jsdom environment)
...
- **Framework:** Jest with jsdom, 207 test files
