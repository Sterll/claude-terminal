...
├── src/renderer/i18n/               # EN/FR/ES/ID/zh-CN locales (3694 keys each)
...
- **Keys:** 3694 per locale, all five in exact sync (enforced by `tests/i18n/i18n-coherence.test.js`)
...
```bash
npm test                    # Run all 174 unit test files (jsdom environment)
